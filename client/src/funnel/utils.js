...
export function getNextStepId(stepId, selectedValue) {
...
export function getNextRoute(stepId, selectedValue) {
  const nextStepId = getNextStepId(stepId, selectedValue);
...
export function getResumeTargetRoute(lastStep, data) {
  if (!lastStep) {
  ...
  const nextRoute = getNextRoute(stepId, selectedValue);
