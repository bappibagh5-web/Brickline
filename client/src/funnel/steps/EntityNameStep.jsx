  ...
  const content = (
    <div className="space-y-5">
      <input
        ...
        className="h-14 w-full rounded-lg border border-[#d4dbeb] bg-white px-5 text-[18px] text-[#2f3f66] placeholder:text-[#8a96b6] transition-all duration-150 focus:border-[#2f54eb] focus:outline-none"
      />
